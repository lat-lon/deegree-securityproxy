...
public interface ServiceManager {
     ...
     *
     * @param httpRequest never <code>null</code>.
     * @return
     * @throws UnsupportedRequestTypeException when the given request does not have the correct service type.
     */
     ...
     *
     * @param authentication the user authentication to authorize, may be <code>null</code>.
     * @param owsRequest     the secured request, never <code>null</code>.
     * @return
     */
     ...
     *
     * @param owsRequest never <code>null</code>.
     * @return
     */
     ...
     * Filter a response.
     *
     * @param wrappedResponse the response to filter, the response may be adjusted during filtering, never
     *                        <code>null</code>.
     * @param authentication  may be <code>null</code>.
     * @param owsRequest      parsed request, never <code>null</code>.
     * @return
     * @throws IOException if an I/O error occurred during writing in the real output stream.
     */
