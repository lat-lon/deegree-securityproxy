...
/**
 * Encapsulates a path and the new value
 * 
...
public class AttributeModificationRule {
    ...
    private final LinkedList<ElementPathStep> path;

    public AttributeModificationRule( String value, LinkedList<ElementPathStep> path ) {
        this.value = value;
        this.path = path;
    }
    ...
    public LinkedList<ElementPathStep> getPath() {
        return path;
    }
