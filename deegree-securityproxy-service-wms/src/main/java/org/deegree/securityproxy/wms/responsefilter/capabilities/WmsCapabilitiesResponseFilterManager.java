...
/**
 * {@link ResponseFilterManager} filtering WMS capabilities documents by user permissions.
 * 
 ...
 */
public class WmsCapabilitiesResponseFilterManager extends AbstractCapabilitiesResponseFilterManager {
     ...
     */
    public WmsCapabilitiesResponseFilterManager( XmlFilter capabilitiesFilter, XmlModificationManagerCreator decisionMakerCreator ) {
        super( capabilitiesFilter, decisionMakerCreator );
    }

    @Override
    protected boolean isCorrectServiceType( OwsRequest owsRequest ) {
        return WmsRequest.class.equals( owsRequest.getClass() );
    }
